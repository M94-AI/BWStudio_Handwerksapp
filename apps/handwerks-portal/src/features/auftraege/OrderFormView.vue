...
// id vorhanden, wenn nicht leer (wir erlauben auch string-IDs wie "ef80" weil das mit meinem JSON FAKE Backend grade so ist)
...
onMounted(async () => {
  if (hasId.value) {
    try {
      ...
      // Defaults setzen, falls Backend Felder weglässt
